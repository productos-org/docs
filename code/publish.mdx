---
title: "Publish"
description: "Ship a Code project to production in one flow, watch the deployment, and connect a custom domain on production-capable paid plans."
---
...
Custom domains and production web deployment are available on Builder, Founder, team, and agency plans. Hobby provides a ProductOS-branded draft preview rather than a production deployment. See [Products, channels and billing](/pricing/products-channels-and-billing).
