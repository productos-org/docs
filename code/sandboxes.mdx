---
title: "Sandboxes"
description: "Every Code project runs in its own isolated cloud sandbox with a live preview URL. Learn the lifecycle, cold boot behavior, and capacity limits."
---
