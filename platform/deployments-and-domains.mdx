...
| --- | --- | --- |
| Branded draft preview | ProductOS preview URL | Hobby |
| Production web deployment | Custom domain, production hosting, and backend | Builder, Founder, team, and agency plans |

Hobby supports draft exploration rather than production operation. Paid plans with active-product capacity can deploy a production web product with a custom domain and backend. Mobile and desktop release operations are separate channels in most plans. See [Products, channels and billing](/pricing/products-channels-and-billing).
