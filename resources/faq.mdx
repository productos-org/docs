...
<AccordionGroup>
  ...
  <Accordion title="Is it free?">
    ProductOS has a \$0 Hobby tier for one personal draft, 100 monthly AI credits, and a branded pipeline preview. Shipping a production product requires Builder or another paid plan. See the [pricing overview](/pricing/overview).
  </Accordion>
</AccordionGroup>
